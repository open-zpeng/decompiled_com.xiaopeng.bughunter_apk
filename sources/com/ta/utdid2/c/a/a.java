...
class a implements XmlSerializer {
    ...
    /* renamed from: a  reason: collision with other field name */
    private Writer f113a;

    /* renamed from: a  reason: collision with other field name */
    private CharsetEncoder f115a;
    private boolean f;
    private int mPos;

    /* renamed from: a  reason: collision with other field name */
    private final char[] f116a = new char[8192];

    /* renamed from: a  reason: collision with other field name */
    private ByteBuffer f114a = ByteBuffer.allocate(8192);
    ...
    private void a(String str, int i, int i2) throws IOException {
        ...
        str.getChars(i, i + i2, this.f116a, i5);
        this.mPos = i5 + i2;
    }
    ...
    private void b() throws IOException {
        int position = this.f114a.position();
        if (position > 0) {
            this.f114a.flip();
            this.f112a.write(this.f114a.array(), 0, position);
            this.f114a.clear();
        }
    }
    ...
    public void flush() throws IOException {
        ...
        if (i > 0) {
            if (this.f112a != null) {
                CharBuffer wrap = CharBuffer.wrap(this.f116a, 0, i);
                CoderResult encode = this.f115a.encode(wrap, this.f114a, true);
                while (!encode.isError()) {
                    if (encode.isOverflow()) {
                        b();
                        encode = this.f115a.encode(wrap, this.f114a, true);
                    } else {
                        b();
                        this.f112a.flush();
                    }
            ...
            this.f113a.write(this.f116a, 0, i);
            this.f113a.flush();
            this.mPos = 0;
        }
    }
    ...
    public void setOutput(OutputStream outputStream, String str) throws IOException, IllegalArgumentException, IllegalStateException {
        if (outputStream != null) {
            try {
                this.f115a = Charset.forName(str).newEncoder();
    ...
    private void append(char[] cArr, int i, int i2) throws IOException {
        ...
        System.arraycopy(cArr, i, this.f116a, i5, i2);
        this.mPos = i5 + i2;
    }
