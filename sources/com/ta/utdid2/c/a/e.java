...
class e {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                if (name.equals("float")) {
                    ...
                    xmlPullParser.next();
                    int[] m63a = m63a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m63a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m62a = m62a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m62a;
    ...
    public static final HashMap m62a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m63a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
