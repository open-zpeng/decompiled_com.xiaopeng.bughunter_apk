...
public class BasePostRequestAdapter<T> implements IRequest {
    ...
    private dd<T> mInternalRequest;

    public BasePostRequestAdapter(String str) {
        this.mInternalRequest = new dd<>(str);
    ...
    public void execute(jc jcVar) {
        this.mInternalRequest.e(jcVar);
    }
    ...
    public IRequest params(String str, File file) {
        this.mInternalRequest.I(str, file);
        return this;
    }
}
