...
public class TrafficStatsEntry {
    ...
    static {
        ...
        sEntry = hashMap;
        hashMap.clear();
        hashMap.put(XWindowUtil.CAR_OTA, new Entry(FIRST_NETWORK_UID, TAG_APP_OTA));
        ...
        hashMap.put(XWindowUtil.CAR_AUTOPILOT, new Entry(100003, TAG_APP_AUTOPILOT));
        hashMap.put(XWindowUtil.CAR_DEVTOOLS, new Entry(100004, TAG_APP_DEV_TOOLS));
        hashMap.put("com.xiaopeng.xuiservice", new Entry(100005, TAG_APP_XUI_SERVICE));
        hashMap.put(XWindowUtil.DATA_COLLECTOR, new Entry(100006, TAG_APP_DATA_COLLECTOR));
        hashMap.put("com.xiaopeng.data.uploader", new Entry(100007, TAG_APP_DATA_UPLOADER));
        hashMap.put(XWindowUtil.CAR_BT_PHONE, new Entry(100008, TAG_APP_BLUETOOTH_PHONE));
        hashMap.put("com.xiaopeng.aiavatarservice", new Entry(100009, TAG_APP_AVATAR_SERVICE));
        hashMap.put(XWindowUtil.DEVICE_COMMUNICATION, new Entry(100010, TAG_APP_DEVICE_COMMUNICATION));
        hashMap.put(XWindowUtil.CAR_CAMERA, new Entry(XWindowUtil.MSG_ID, TAG_APP_CAR_CAMERA));
        hashMap.put(XWindowUtil.CAR_GALLERY, new Entry(100012, TAG_APP_CAR_GALLERY));
        hashMap.put("com.android.car", new Entry(100013, TAG_APP_CAR_SERVICE));
        hashMap.put(XWindowUtil.CAR_ACCOUNT, new Entry(100014, TAG_APP_CAR_ACCOUNT));
        hashMap.put(XWindowUtil.CAR_CONTROL, new Entry(100015, TAG_APP_CAR_CONTROL));
