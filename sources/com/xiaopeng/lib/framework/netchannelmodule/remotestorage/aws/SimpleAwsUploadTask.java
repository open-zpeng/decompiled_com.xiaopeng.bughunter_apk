...
public class SimpleAwsUploadTask extends BaseAwsTask {
    ...
    public void executeUploadTask(final String str) {
        ag.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.aws.SimpleAwsUploadTask.2
    ...
    private JsonObject wrapJsonBody(UploadInfo uploadInfo) {
        ...
        Map<String, String> map = this.mCallbackParams;
        if (map != null) {
            jsonObject.addProperty("call_back", new JSONObject(map).toString());
        }
        return jsonObject;
    }
