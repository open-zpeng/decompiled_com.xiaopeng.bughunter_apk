...
public final class TokenRetriever {
    ...
    public class GetTokenCallback implements Callback {
        ...
        public void onFailure(IResponse iResponse) {
            ...
            tf.f(TokenRetriever.TAG, "Request token error! the error message---->" + iResponse.message());
    ...
    public void callFailureCallbacks(final StorageException storageException) {
        ag.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.2
    ...
    public void callSuccessCallbacks(final Token token) {
        ag.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.remotestorage.token.TokenRetriever.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void clearToken() {
        this.mToken = null;
        tf.a(TAG, "Clear the existing token!");
    }
