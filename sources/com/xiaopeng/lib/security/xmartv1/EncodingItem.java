...
public final class EncodingItem {
    ...
    private boolean encodeInternal() {
        ...
        tf.a(TAG, "Failed to encrypt the string.");
        return false;
    }
    ...
    public String rawContentString() {
        ...
        try {
            ...
            tf.a(TAG, "Failed to convert raw content to string!");
            return "";
        }
    }
