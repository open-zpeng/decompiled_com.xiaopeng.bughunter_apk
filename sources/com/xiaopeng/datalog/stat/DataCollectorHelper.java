...
public class DataCollectorHelper {
    ...
    private Handler mHandler = new Handler(ag.g(0), new Handler.Callback() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.1
        @Override // android.os.Handler.Callback
        public boolean handleMessage(Message message) {
            int i = message.what;
            if (i == 1) {
                tf.r(DataCollectorHelper.TAG, "handleMessage MESSAGE_DUMP_CAN");
                DataCollectorHelper.this.dumpCan2File();
            } else if (i == 2) {
                tf.a(DataCollectorHelper.TAG, "handleMessage MESSAGE_DUMP_CDU");
                DataCollectorHelper.this.dumpCdu2File();
            } else if (i == 3) {
                tf.a(DataCollectorHelper.TAG, "handleMessage MESSAGE_CHECK_CONNECTION");
    ...
    private ServiceConnection mConnection = new ServiceConnection() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.2
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            tf.a(DataCollectorHelper.TAG, "onServiceConnected");
            DataCollectorHelper.this.remoteService = hf.a.l0(iBinder);
            ...
            try {
                ...
                tf.t(DataCollectorHelper.TAG, "RemoteException occurs when reLink to Service, exception:", e);
            }
        }

        @Override // android.content.ServiceConnection
        public void onServiceDisconnected(ComponentName componentName) {
            tf.a(DataCollectorHelper.TAG, "onServiceDisconnected");
            DataCollectorHelper.this.remoteService = null;
            DataCollectorHelper.this.bindService();
        }
    };
    ...
    private String buildCanDataZipJson() {
        ...
        try {
            create.setV(Integer.valueOf(yf.b()).intValue());
        } catch (Exception e) {
            tf.t(TAG, "parse dbcVersion error!", e);
            create.setV(0);
        }
    ...
    public void dumpCan2File() {
        if (this.mCanDataCache.isEmpty()) {
            tf.a(TAG, "mCanDataCache.isEmpty(), return!");
            return;
        }
        ye.h().n("candata", bg.b(buildCanDataZipJson()), this.mContext);
    ...
    public void dumpCdu2File() {
        if (this.mCduDataCache.isEmpty()) {
            tf.a(TAG, "mCduDataCache.isEmpty(), return!");
        }
        ye.h().n("cdudata", bg.b(buildCduDataZipJson()), this.mContext);
    ...
    private String[] generateUploadInfos() {
        ...
        String str = BUCKET_NAME + "/log/" + gg.e() + "/" + rf.c(currentTimeMillis) + "/" + yf.h();
    ...
    public void zipAndEncrypt(String str, List<String> list) {
        ...
        deleteLocalFile(file, eg.c(file, new File(str.replace(".zip", "_en.zip")), "@!chxpzi#0109$+/"));
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void uploadCduWithFiles(final ve veVar, final List<String> list) {
        final String[] generateUploadInfos = generateUploadInfos();
        ag.i(new Runnable() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.5
            @Override // java.lang.Runnable
            public void run() {
                DataCollectorHelper.this.zipAndEncrypt(generateUploadInfos[1], list);
                veVar.put("address", generateUploadInfos[0]);
                String json = veVar.toJson();
                ArrayList arrayList = new ArrayList();
    ...
    */
    public void uploadLogOrigin(java.lang.String r3, java.lang.String r4) {
        ...
        L19:
            if (r0 != 0) goto L53
            java.lang.Class<se> r0 = defpackage.se.class
    ...
    public String uploadRecentSystemLog() {
        ...
        ag.i(new Runnable() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.6
            @Override // java.lang.Runnable
            public void run() {
                if (DataCollectorHelper.this.isConnected()) {
                    DataCollectorHelper.this.internalUploadRecentSystemLog(str);
                } else {
                    ag.j(new Runnable() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.6.1
                        @Override // java.lang.Runnable
                        public void run() {
