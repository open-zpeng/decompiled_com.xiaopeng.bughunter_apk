...
public class StatMqttDelegate extends AbstractStatDelegate implements Handler.Callback {
    ...
    private class StatEventWithFiles {
        ...
        public StatEventWithFiles(ve veVar, List<String> list) {
            this.event = veVar;
            this.filePaths = list;
        }
    }
    ...
    public void uploadCdu(final IStatEvent iStatEvent) {
        ag.h(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.1
            @Override // java.lang.Runnable
            public void run() {
                tf.a(StatMqttDelegate.TAG, "uploadCdu stat:" + iStatEvent.toString());
    ...
    public void uploadCduWithFiles(IStatEvent iStatEvent, List<String> list) {
        StatEventWithFiles statEventWithFiles = new StatEventWithFiles((ve) iStatEvent, list);
        if (!DataCollectorHelper.getInstance().isConnected()) {
    ...
    public void uploadCdu(final IMoleEvent iMoleEvent) {
        ag.h(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.2
            @Override // java.lang.Runnable
            public void run() {
                tf.a(StatMqttDelegate.TAG, "uploadCdu mole:" + iMoleEvent.toString());
