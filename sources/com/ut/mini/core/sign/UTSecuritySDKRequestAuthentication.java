...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    */
    ...
    public String getSign(String str) {
        ...
        if (this.g == null) {
            ya.a("UTSecuritySDKRequestAuthentication:getSign", "There is no appkey,please check it!");
            return null;
        } else if (str == null || this.b == null || (cls = this.a) == null || this.f132a == null || this.f134b == null || this.f135c == null || this.f133a == null || this.c == null) {
            return null;
        } else {
            try {
                ...
                return (String) this.f133a.invoke(this.c, newInstance, this.ad);
