    ...
    */
    ...
    public void h5UT(Map<String, String> map, Object obj) {
        if (map != null && map.size() != 0) {
            ...
            if (str == null) {
                ya.a("h5UT", "funcType is null");
                return;
            }
            String str2 = map.get("utjstype");
            if (str2 != null && !str2.equals("0") && !str2.equals("1")) {
                ya.a("h5UT", "utjstype should be 1 or 0 or null");
                return;
            }
            map.remove("functype");
            Date date = new Date();
        ...
        if (b != null && !TextUtils.isEmpty(b)) {
            ...
            if (str != null && !TextUtils.isEmpty(str)) {
                ...
                if (defaultTracker != null) {
                    ...
                    ya.a("h5Ctrl event error", "Fatal Error,must call setRequestAuthentication method first.");
                    return;
                }
            }
            ya.d("h5Ctrl", "logkey is null,return");
            return;
        }
        ya.d("h5Ctrl", "pageName is null,return");
    }
}
