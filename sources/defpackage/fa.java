...
public class fa {
    ...
    private static String b(String str) {
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(ea.j());
    ...
    public static String j() {
        if (TextUtils.isEmpty(c)) {
            ...
            k(fb.b(j2, "utanalytics_https_host"));
        }
        return c;
    }
    ...
    public static void q(Map<String, String> map) {
        ya.c("Config", "[turnOnRealTimeDebug] params:", map);
        if (map != null) {
